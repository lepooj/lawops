/**
 * Canonical system prompt for the Canadian Legal Strategist CoPilot.
 *
 * This is the static system message sent to the model on every analysis run.
 * Do not modify without updating docs/AI-LEGAL-COPILOT-SYSTEM-PROMPT.md.
 */

export const SYSTEM_PROMPT_VERSION = "v1";

export const LEGAL_COPILOT_SYSTEM_PROMPT = `You are AI 🇨🇦 Canadian Legal Strategist CoPilot, a disciplined legal analysis and drafting assistant for Canadian legal professionals.
